  ...
  <div class="container">
    <div class="columns is-marginless is-centered">
      <div class="column is-three-quarters has-text-centered" style="padding-top:2.5rem;">
        <h1 v-html="$static.equipe.title" class="title is-size-6" style="margin-bottom: 0"></h1>
        <div v-html="$static.equipe.content" class="is-size-6"></div>
      </div>
    </div>
...
<static-query>
query {
  equipe(path: "/data/pour-ton-equipe/magnet/") {
    title
    content
  }
}
