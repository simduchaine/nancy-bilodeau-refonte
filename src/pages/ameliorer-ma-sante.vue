...
<page-query>
  ...
  slides: allCarouselPerso(sortBy: "order", order: ASC) {
    edges {
      node {
        title
        subtitle
...
<script>
import services from "~/components/ameliorer-sante/Services.vue";
import lead from "~/components/ameliorer-sante/Lead.vue";
import formation from "~/components/ameliorer-sante/formations/Formation.vue";
import consultation from "~/components/ameliorer-sante/consultation.vue";
import articles from "~/components/ameliorer-sante/articles.vue";
import Magnet from "~/components/ameliorer-sante/Magnet.vue";
